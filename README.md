...
🇳🇵 Nepal Aviation Infrastructure Dashboard & Analysis
## 📌 Project Overview  
The Nepal Aviation Infrastructure Dashboard & Analysis project focuses on exploring, analyzing, and visualizing Nepal’s aviation facilities, including airports and heliports, to generate meaningful, data-driven insights. The project combines data cleaning, geospatial analysis, forecasting, and interactive visualization to support better understanding of aviation distribution and usage across Nepal.  
...
### Run mapping script  
python Mapping_with_Folium.py  

### Run forecasting  
python Forecast_using_Prophet.py  

### (Optional) Run Streamlit app  
streamlit run app.py  

## 📁 Project Structure  
Nepal_Aviation_Infrastructure/  
│  
├── data/  
│   └── Aerodromes.csv  
│  
├── Forecast_using_Prophet.py  
├── Mapping_with_Folium.py  
├── app.py  
├── requirements.txt  
└── README.md  
